...
function inner_single_aside(){var e=jQuery(".inner-news article").height();e&&jQuery(".inner-news aside").height(e)}jQuery(document).ready(function(e){new mlPushMenu(document.getElementById("mp-menu"),document.getElementById("trigger"),{type:"cover"});var n=jQuery(".owl-carousel-agenda");n.owlCarousel({loop:!0,autoWidth:!0,items:1,margin:8,onInitialized:function(i){var t=0;n.find("dd").each(function(n,i){t<e(this).height()&&(t=e(this).height())}),n.find("dd").height(t)}}),jQuery(".owl-carousel-agenda-next").on("click",function(e){e.preventDefault(),n.trigger("next.owl.carousel")}),jQuery(".owl-carousel-videos-highlight").owlCarousel({loop:!0,nav:!0,items:3,navText:['<i class="fa fa-angle-left"></i>','<i class="fa fa-angle-right"></i>']}),jQuery(".list-news-column").masonry({itemSelector:".grid-item"}),inner_single_aside()}),jQuery(window).resize(function(e){inner_single_aside()});